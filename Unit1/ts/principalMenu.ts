module MrBook {
    export class PrincipalMenu extends Phaser.State {
        ...
        create() {
            ...
            this.btnStart = this.game.add.button(this.game.world.centerX - 200, 250, 'btnStart1', () => {
                this.game.state.start("Topic1_1") }, this, 0, 1, 2);
            this.btnStart.anchor.x = 0.5;
            this.btnStart.scale.set(0.8, 0.8);
            this.btnStart = this.game.add.button(this.game.world.centerX, 250, 'btnStart2', () => {
                this.game.state.start("Topic1_2") }, this, 0, 1, 2);
            this.btnStart.anchor.x = 0.5;
            this.btnStart.scale.set(0.8, 0.8);
            this.btnStart = this.game.add.button(this.game.world.centerX + 200, 250, 'btnStart3', () => {
                this.game.state.start("Topic1_3") }, this, 0, 1, 2);
            this.btnStart.anchor.x = 0.5;
            this.btnStart.scale.set(0.8, 0.8);
            this.btnStart = this.game.add.button(this.game.world.centerX, 350, 'btnStart2', () => {
                this.game.state.start("LoadTopic8_1") }, this, 0, 1, 2);
            this.btnStart.anchor.x = 0.5;
            this.btnStart.scale.set(0.8, 0.8);

            this.btnStore = this.game.add.button(100, this.game.world.height - 80, 'btnStore', () => {
