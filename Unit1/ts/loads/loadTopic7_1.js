...
var MrBook;
(function (MrBook) {
    var LoadTopic7_1 = /** @class */ (function (_super) {
        __extends(LoadTopic7_1, _super);
        function LoadTopic7_1() {
            ...
            _this.loadComplete = function () {
                if (MrBook.productsStore.length == 0) {
                    $.getJSON("https://www.mrbook.com.co/api/php/crud.php", { 'option': 'GetAll', 'tabla': 'mb_product' })
                        ...
                        _this.game.state.start("Topic7_1", true);
                    })
        ...
        LoadTopic7_1.prototype.preload = function () {
            this.superPreload();
            this.load.image('bgrTable', 'assets/images/backgrounds/table.jpg');
            this.game.load.atlas('sprDominoes', 'assets/images/sprites/dominoes.png', 'assets/images/sprites/dominoes.json');
    ...
    MrBook.LoadTopic7_1 = LoadTopic7_1;
})(MrBook || (MrBook = {}));
//# sourceMappingURL=loadTopic7_1.js.map