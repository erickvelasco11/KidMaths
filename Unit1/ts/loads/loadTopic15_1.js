...
var MrBook;
(function (MrBook) {
    var LoadTopic15_1 = /** @class */ (function (_super) {
        __extends(LoadTopic15_1, _super);
        function LoadTopic15_1() {
            ...
            _this.loadComplete = function () {
                if (MrBook.productsStore.length == 0) {
                    $.getJSON("https://www.mrbook.com.co/api/php/crud.php", { 'option': 'GetAll', 'tabla': 'mb_product' })
                        ...
                        _this.game.state.start("Topic15_1", true);
                    })
        ...
        return LoadTopic15_1;
    }(MrBook.Loads));
    MrBook.LoadTopic15_1 = LoadTopic15_1;
})(MrBook || (MrBook = {}));
//# sourceMappingURL=loadTopic15_1.js.map