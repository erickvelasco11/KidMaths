module MrBook {
    export class Topic1_1 extends Topic {
        ...
        create() {
            ...
            var box1 = this.boxes.create(this.world.centerX / 3, 470, "itmFruitBasket");
            box1.anchor.setTo(0.5, 0.5);
            box1.width = 120;
            box1.height = 120;
            box1.enableBody = true;
            box1.body.immovable = true;
            var box2 = this.boxes.create(this.world.centerX, 470, "itmSchoolBag");
            box2.anchor.setTo(0.5, 0.5);
            box2.width = 120;
            box2.height = 120;
            box2.enableBody = true;
            box2.body.immovable = true;
            var box3 = this.boxes.create(this.world.width - (this.world.centerX / 3), 470, "itmClothesbasket");
