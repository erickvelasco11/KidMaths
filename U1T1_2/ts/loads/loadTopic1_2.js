...
var MrBook;
(function (MrBook) {
    var LoadTopic1_2 = /** @class */ (function (_super) {
        __extends(LoadTopic1_2, _super);
        function LoadTopic1_2() {
            ...
            _this.loadComplete = function () {
                if (MrBook.productsStore.length == 0) {
                    $.getJSON("https://www.mrbook.com.co/api/php/crud.php", { 'option': 'GetAll', 'tabla': 'mb_product' })
                        ...
                        _this.game.state.start("Topic1_2", true);
                    })
    ...
    MrBook.LoadTopic1_2 = LoadTopic1_2;
})(MrBook || (MrBook = {}));
//# sourceMappingURL=loadTopic1_2.js.map